...
<div class="main-panel">
      ...
      <div class="row">
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title p-3" style="border-radius:15px; color:whitesmoke; background-color:#4B49AC">Bulk Booking</h4>

                   <?php
                      echo form_open_multipart(base_url() . 'Import_class/import_bluk_room_details/' , array('data-toggle' => 'validator', 'role' => 'form','class'=>'form-sample'));
                    ?>
