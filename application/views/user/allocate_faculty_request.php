      ...
      <div class="col-12 grid-margin">
        <div class="card">
          <div class="card-body">
            ...
            <form class="form-sample" method="post" action="<?php echo base_url(); ?>Dashboard_user/allocate_faculty_request/<?php echo $allocate_detail->id; ?>">
              ...
              <div id="disabled_text">  
                ...
                <button class="btn btn-light" href="<?php echo base_url()?>Dashboard_user/open_form">Cancel</button>
              </div>
            </form>
                ...
                <!-- ////////////////////// Edit BUTTON ////////////////////// -->
            <form class="form-sample" method="post" action="<?php echo base_url(); ?>Dashboard_user/edit_faculty_req/<?php echo $allocate_detail->id;?>">
