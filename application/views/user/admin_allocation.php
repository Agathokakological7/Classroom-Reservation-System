...
option {
  color: black;
      ...
      <div class="main-panel">        
        ...
        <form class="form-sample" method="post" action="<?php echo base_url(); ?>Dashboard_user/admin_allocation">
          <div class="row">
      ...
      <tbody>
        <?php foreach ($allotment->result() as $row) {  ?>
          <tr>
              ...
              <a class="badge badge-success edit_btn" href="<?php echo base_url()?>Dashboard_user/faculty_request_allocate_form/<?php echo $row->id?>">Approve</a>
              </td>
            </tr>
        <?php } ?>
      </tbody>
        ...
        <?php foreach ($available_venue->result() as $row) {  
          if($row->room_type_name == $select_rm_type or $select_rm_type == 'All'){ ?>
            <tr>
              ...
              <td class="font-weight-medium">
                <a class="badge badge-success edit_btn" href="<?php echo base_url()?>Dashboard_user/class_room_booking/<?php echo $row->id?>">Allocate</a> 
              </td>
            </tr>
          <?php }  
        }?>
