            ...
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="form-sample" method="post" action="<?php echo base_url(); ?>Dashboard_user/room_type_data/<?php echo $room_data->id; ?>">
                    ...
                    <div class="col-md-6">
                      ...
                      <button type="submit" class="btn btn-primary ml-auto" >ADD</button>
                        ...
                        <div class="form-group row">
                          <div class="col-sm-6">
                          <button type="submit" class="btn btn-primary ml-auto" href="<?php echo base_url()?>Dashboard_user/edit_room_type/<?php echo $room_data->id ?>" >SAVE</button>
                          </div>
                          <div class="col-sm-6">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="font-weight-medium">
                      <a class="badge badge-success edit_btn" href="<?php echo base_url(); ?>Dashboard_user/add_room/<?php echo $row->id;?>">Edit</a>
                      <a class="badge badge-danger" href="<?php echo base_url(); ?>Dashboard_user/room_type_deletes/<?php echo $row->id;?>">Delete</a>       
                    </td>
                  </tr>
                  <?php } ?>
                </tbody>
